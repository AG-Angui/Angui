...
CREATE TABLE intake_answer_revisions (
    ...
    structured_json TEXT, revision_kind VARCHAR(16) NOT NULL CHECK (revision_kind IN ('submitted', 'corrected')),
    created_by_user_id VARCHAR(36) NOT NULL, created_at VARCHAR(40) NOT NULL,
