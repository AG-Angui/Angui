...
-- statement-break
ALTER TABLE clues ADD COLUMN longitude DOUBLE PRECISION;
-- statement-break
ALTER TABLE clues ADD COLUMN latitude DOUBLE PRECISION;
-- statement-break
ALTER TABLE clues ADD COLUMN location_radius_meters DOUBLE PRECISION;
-- statement-break
