ALTER TABLE clues ADD COLUMN location_kind VARCHAR(32) NULL;
-- statement-break
ALTER TABLE clues ADD COLUMN longitude DOUBLE NULL;
-- statement-break
ALTER TABLE clues ADD COLUMN latitude DOUBLE NULL;
-- statement-break
ALTER TABLE clues ADD COLUMN location_radius_meters DOUBLE NULL;
-- statement-break
ALTER TABLE clues ADD COLUMN visibility VARCHAR(32) NULL;
-- statement-break
ALTER TABLE clues ADD COLUMN confidence VARCHAR(32) NULL;
-- statement-break
ALTER TABLE clues ADD COLUMN created_by_user_id VARCHAR(255) NULL;
-- statement-break
ALTER TABLE clues ADD COLUMN legacy_case_place_id VARCHAR(255) NULL;
-- statement-break
...
SELECT UUID(), case_id,
       ...
       source, 'location_report', CONCAT(name, ': ', address), id, created_at, created_at,
...
SELECT UUID(), p.case_id, 'system', 'location_clue.migrated', 'clue', c.id,
