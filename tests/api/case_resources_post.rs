...
async fn post_case_places_requires_family_or_commander_and_returns_pending_review() {
    ...
    let response = test::call_service(&app, test::TestRequest::post()
        ...
        .set_json(json!({
            ...
            "longitude": 117.2272, "latitude": 31.8206, "source": "family_report", "visibility": "confirmed"
        })).to_request()).await;
    ...
    let denied = test::call_service(&app, test::TestRequest::post()
        ...
        .set_json(json!({ "name": "Home", "place_type": "other", "address": "Private", "source": "volunteer", "visibility": "internal" })).to_request()).await;
    ...
    let station = |place_type: &str| {
        test::TestRequest::post()
            ...
            .set_json(json!({
                ...
                "source": "family_report", "visibility": "confirmed"
            }))
            .to_request()
    };
